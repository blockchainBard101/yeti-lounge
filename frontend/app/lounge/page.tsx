    ...
    <div className="space-y-6 pb-16">
      ...
      <section className="glass-panel rounded-3xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { icon: "💎", step: "1. Claim Flurries", desc: "Head to the Dashboard to collect daily claim tokens on Sui.", href: "/quests" },
            { icon: "📢", step: "2. Shill Memes", desc: "Post hot takes, Sui alpha, and lofi art in the Community Feed.", href: "/" },
